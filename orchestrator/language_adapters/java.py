...
This module implements the Java language adapter for compiling and executing
Java code using javac and java with proper resource limits.
"""
...
class JavaAdapter(LanguageAdapter):
    ...
    def __init__(self):
        super().__init__()
        self.name = "java"
        self.entry_file = "Main.java"
        self.runtime_cmd = ["java", "Main"]
    ...
    def compile(self, workdir: Path) -> CompileResult:
        ...
        Args:
            workdir: Path to directory containing Java source code
        ...
        try:
            ...
            return CompileResult(
                success=False,
                stderr=f"Unexpected error during compilation: {str(e)}",
                exit_code=1,
                compile_time_ms=compile_time_ms
            )
    ...
    def run(self, workdir: Path, stdin_path: Path, stdout_path: Path,
        ...
        """
        Execute compiled Java code with resource limits.

        Args:
            workdir: Path to directory containing compiled .class file
        ...
        # Prepare command
        cmd = ["java", f"-Xmx{limits.memory_mb}m", "Main"]
    ...
    def get_template_content(self) -> str:
        """
        Get Java template content.

        Returns:
            Java template source code
        """
...
'''
    ...
    def validate_solution(self, workdir: Path) -> bool:
        """
        Validate that Java solution file exists and has basic structure.
        ...
        try:
            ...
            has_class = 'class Main' in content
            has_main = 'public static void main' in content

            return has_class and has_main
